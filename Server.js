...
Server.get('/refresh', (req,res)=>{
    ...
    conexion.query('SELECT * FROM db_data', (error,data)=>{
        ...
        res.render("Database", { Machine_db: data })
...
//Eliminar articulo
Server.post('/delete/:host', (req,res) => {

    const host = req.params.host
    // console.log(host)

    conexion.query('DELETE FROM db_data WHERE host = ?', [host], function(error, data){
        if(error) throw error  
...
Server.post('/select', (req,res) => {
    ...
    // const host = req.params.host
    console.log("hemos seleccionado la maquina")
